...
Задачи
------
- [ ] В sourcepath (src/main/java) cоздайте пакет decorator
...
- [ ] В основном классе приложения Applicaiton выводите не сообщение, а результат обогащения этого сообщения
