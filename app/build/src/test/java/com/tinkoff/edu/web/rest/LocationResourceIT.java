...
class LocationResourceIT {
    ...
    void putNewLocation() throws Exception {
        ...
        updatedLocation.postalCode(UPDATED_POSTAL_CODE).streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY).province(UPDATED_PROVINCE);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.postalCode(UPDATED_POSTAL_CODE).city(UPDATED_CITY).province(UPDATED_PROVINCE);
