...
import static com.tinkoff.edu.web.rest.TestUtil.sameNumber;
...
import com.tinkoff.edu.repository.JobRepository;
...
class JobResourceIT {
    ...
    private static final BigDecimal DEFAULT_MIN_SALARY = new BigDecimal(12792);
    private static final BigDecimal UPDATED_MIN_SALARY = new BigDecimal(12793);
    ...
    void createJob() throws Exception {
        ...
        assertThat(testJob.getMaxSalary()).isEqualByComparingTo(DEFAULT_MAX_SALARY);
    }
    ...
    void fullUpdateJobWithPatch() throws Exception {
        ...
        assertThat(testJob.getJobTitle()).isEqualTo(UPDATED_JOB_TITLE);
        assertThat(testJob.getMinSalary()).isEqualByComparingTo(UPDATED_MIN_SALARY);
        assertThat(testJob.getMaxSalary()).isEqualByComparingTo(UPDATED_MAX_SALARY);
    }
