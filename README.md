Автоматизация QA <sup>4 мес</sup>
================
...
- 1 вебинар в неделю по 1.5 часа (1 час контент + 0.5 обсуждение вопросов)
- reference/выжимка по каждому вебинару
- задания для самостоятельной проработки ~1.5 часа трудоемкости в неделю
