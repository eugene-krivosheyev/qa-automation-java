...
- [ ] Self-made tests implemented (with main class)
- [ ] Made and implemented design decisions about when and where are objects of Controller, Service, Repo created (new operator) 
- [x] Application implemented with DI creational pattern
### Then
- [ ] Проект успешно собирается
- [ ] Выдержан стиль кодирования и соглашения
- [ ] Ментор принимает PR в `master`
